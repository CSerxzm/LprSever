...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <%
    	String pageName = "", parklot="",parkspace="",trarecord="",notice="",user="",walletrecord="",upload="";
    ...
    <ul class="layui-nav layui-layout-left">
	      ...
	      <li class="layui-nav-item<%=walletrecord%>"><a href="Main?page=walletrecord">费用管理</a></li>
